...
import { fetchClientes, salvarAvaliacao } from '../api';
...
const AvaliacaoVeiculo: React.FC = () => {
    ...
    const handleSubmit = async (e?: React.FormEvent | React.MouseEvent) => {
        ...
        const avaliacao = {
            ...
            observacoes: 'Avaliação técnica e comercial realizada via Painel Web',
            itens: [
        ...
        try {
            ...
            setSuccessMsg('✓ Avaliação cadastrada com sucesso! O veículo foi incluído no Estoque como "Em Avaliação" e está pronto para ser utilizado como Veículo na Troca em Vendas.');
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div>
                        ...
                        <div className="form-group">
                            ...
                            <input 
                                ...
                                placeholder="Ex: BRA2E19 ou GCS-7788" 
                ...
                <div className="glass-panel" style={{ padding: '24px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '24px' }}>
                        ...
                        <div className="form-group">
                            <label className="form-label">Valor de Mercado Estimado (R$)</label>
