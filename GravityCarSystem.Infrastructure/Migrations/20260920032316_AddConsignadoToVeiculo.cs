...
{
    /// <inheritdoc />
    public partial class AddConsignadoToVeiculo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeRazaoSocial = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estado = table.Column<string>(type: "TEXT", nullable: true),
                    Ativa = table.Column<bool>(type: "INTEGER", nullable: false),
                    SaldoConsultas = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataRecarga = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricoRecargas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmitenteCnpj = table.Column<string>(type: "TEXT", nullable: true),
                    EmitenteNome = table.Column<string>(type: "TEXT", nullable: true),
                    DestinatarioCnpj = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Placa = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    Renavam = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Chassi = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    ...
                    AnoFabricacao = table.Column<short>(type: "INTEGER", nullable: true),
                    AnoModelo = table.Column<short>(type: "INTEGER", nullable: true),
                    ...
                    Status = table.Column<byte>(type: "INTEGER", nullable: false),
                    Consignado = table.Column<bool>(type: "INTEGER", nullable: false),
                    Observacoes = table.Column<string>(type: "TEXT", nullable: true),
                    DataCadastro = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DataAtualizacao = table.Column<DateTime>(type: "TEXT", nullable: true),
                    EmpresaId = table.Column<Guid>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComissaoPercent = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataCusto = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    VeiculoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TipoDocumento = table.Column<byte>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClienteId = table.Column<Guid>(type: "TEXT", nullable: false),
                    UsuarioId = table.Column<Guid>(type: "TEXT", nullable: false),
                    NumeroVenda = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VeiculoId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ClienteId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ValorAtribuido = table.Column<decimal>(type: "TEXT", nullable: false),
                    ValorAvaliacao = table.Column<decimal>(type: "TEXT", nullable: false),
                    Observacoes = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    VendaPagamentoId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ClienteId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Banco = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Agencia = table.Column<string>(type: "TEXT", nullable: true),
                    Conta = table.Column<string>(type: "TEXT", nullable: true),
                    NumeroCheque = table.Column<string>(type: "TEXT", nullable: true),
                    Valor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DataEmissao = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DataBomPara = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Status = table.Column<byte>(type: "INTEGER", nullable: false),
                    DataDeposito = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DataCompensacao = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Observacao = table.Column<string>(type: "TEXT", nullable: true),
                    DataCadastro = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DataAtualizacao = table.Column<DateTime>(type: "TEXT", nullable: true),
                    EmpresaId = table.Column<Guid>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ContaFinanceiraId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CategoriaId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Tipo = table.Column<byte>(type: "INTEGER", nullable: false),
                    Valor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    ChequeId = table.Column<Guid>(type: "TEXT", nullable: true),
                    UsuarioId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DataCadastro = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DataAtualizacao = table.Column<DateTime>(type: "TEXT", nullable: true),
                    EmpresaId = table.Column<Guid>(type: "TEXT", nullable: false)
